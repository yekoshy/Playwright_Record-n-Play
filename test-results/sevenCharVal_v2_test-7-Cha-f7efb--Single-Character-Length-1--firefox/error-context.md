...
- Name: sevenCharVal_v2_test.spec.ts >> 7-Character Validation Tests >> TC09: Single Character (Length 1)
...
Call log:
  - waiting for getByRole('button', { name: 'Check Input' })
    - locator resolved to <input type="button" name="validate" value="Check Input" onclick="processValidation(1);"/>
